...
esp_err_t EMC2302_init() {
    ...
    ESP_RETURN_ON_ERROR(i2c_bitaxe_register_write_byte(emc2302_dev_handle, EMC2302_FAN1_CONFIG1, 0b00001011), TAG, "Failed to configure fan 1 settings");
    ESP_RETURN_ON_ERROR(i2c_bitaxe_register_write_byte(emc2302_dev_handle, EMC2302_FAN2_CONFIG1, 0b00001011), TAG, "Failed to configure fan 2 settings");
    ESP_RETURN_ON_ERROR(i2c_bitaxe_register_write_byte(emc2302_dev_handle, EMC2302_PWM_POLARITY, 0b00000011), TAG, "Failed to set PWM polarity");
...
uint16_t EMC2302_get_fan_speed(uint8_t devicenum) {
    ...
    err = i2c_bitaxe_register_read(emc2302_dev_handle, TACH_LSB_REG, &tach_lsb, 1);
    if (err != ESP_OK) {
