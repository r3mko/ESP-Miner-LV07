...
esp_err_t device_config_init(void * pvParameters)
{
    ...
    GLOBAL_STATE->DEVICE_CONFIG.TMP1075_A = nvs_config_get_u16(NVS_CONFIG_TMP1075_A, 0);
    GLOBAL_STATE->DEVICE_CONFIG.TMP1075_B = nvs_config_get_u16(NVS_CONFIG_TMP1075_B, 0);
