...
static const FamilyConfig FAMILY_LV07        = { .id = LV07,        .name = "LV07",       .asic = ASIC_BM1366, .asic_count = 2, .max_power = 60, .power_offset = 7,  .nominal_voltage = 12, .swarm_color = "orange", };
...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "302",  .family = FAMILY_LV07,        .EMC2302_LV07 = true, .TMP1075_A = 0x4A, .TMP1075_B = 0x4B,                  .emc_temp_offset = 5,   .TPS546 = true,                                                           .power_consumption_target = 25, },
