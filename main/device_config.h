...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "302",  .family = FAMILY_LV07,        .pins = BITAXE_ORIGINAL_PINS, .EMC2302_LV07 = true, .TMP1075_A = 0x4A, .TMP1075_B = 0x4B,                  .temp_offset = 5,   .TPS546 = true,                                                           .power_consumption_target = 25,  },
    { .board_version = "303",  .family = FAMILY_LV08,        .pins = BITAXE_ORIGINAL_PINS, .EMC2302_LV07 = true, .TMP1075_A = 0x4A, .TMP1075_B = 0x4B,                  .temp_offset = 5,   .TPS546_LV08 = true, .TPS546_0 = 0x7F, .TPS546_1 = 0x24, .TPS546_2 = 0x14,.power_consumption_target = 125, },
    { .board_version = "312",  .family = FAMILY_LV07_PRO,    .pins = BITAXE_ORIGINAL_PINS, .EMC2302_LV07 = true, .TMP1075_A = 0x4A, .TMP1075_B = 0x4B,                  .temp_offset = 5,   .TPS546 = true,                                                           .power_consumption_target = 40,  },
