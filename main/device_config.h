...
static const FamilyConfig FAMILY_GAMMA_DUO   = { .id = GAMMA,       .name = "Gamma",      .asic = ASIC_BM1370, .asic_count = 2, .max_power =  40, .power_offset = 5,  .nominal_voltage = 5,  .voltage_domains = 1, .swarm_color = "green",    };
