...
static const FamilyConfig FAMILY_LV08        = { .id = LV08,        .name = "LV08",       .asic = ASIC_BM1366,   .asic_count = 9, .max_power = 140, .power_offset = 14, .nominal_voltage = 12, .voltage_domains = 1, .swarm_color = "orange",   };
