...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_STRATUM_DECODE_COINBASE]               = {.nvs_key_name = "stratumdecode",   .type = TYPE_BOOL,  .default_value = {.b   = false},                                       .rest_name = "stratumDecodeCoinbase",              .min = 0,  .max = 1},
    ...
    [NVS_CONFIG_FALLBACK_STRATUM_DECODE_COINBASE]      = {.nvs_key_name = "fbstratumdecode", .type = TYPE_BOOL,  .default_value = {.b   = false},                                       .rest_name = "fallbackStratumDecodeCoinbase",      .min = 0,  .max = 1},
